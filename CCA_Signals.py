###this exemple was originally implemented for SyncPy library 
###you can find it on the link bellow:
###https://github.com/syncpy/SyncPy/blob/master/examples/CCA_Signals.py
...
x = pd.read_csv('CCAVoicedata.csv')
y = pd.read_csv('CCAFilteredAU.csv')
